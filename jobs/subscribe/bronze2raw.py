    ...
    for topic_class in [RawToBronzeTopic]:
        ...
        for topic_name in all_topic_names:
            ...
            if topic_name == topic_class.REVIEW:
                ...
                load_stream(review_info, review_metatdata_schema_str)

                review_preprocessed_schema_str = client.get_latest_version(BronzeToSilverTopic.REVIEW_PREPROCESSED).schema.schema_str
                ...
                load_stream(clean_msg_df, review_preprocessed_schema_str)

            else:
                pass

            # qeury = start_console_stream(cleaned_msg_df)
