...
docker compose -f docker-compose.spark-control-plane.yml exec spark-client spark-submit \
  ...
  --conf spark.executor.extraJavaOptions="-Daws.region=us-east-1 -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=9082 -javaagent:/mnt/shared/jmx_prometheus_javaagent-1.3.0.jar=9081:/mnt/configs/jmx/spark_executor.yml" \
